...
public class BastaChicos {
	...
	private static CargaView crearCargaView() {
		...
		CargaView cv = new CargaView(TipoCarga.BIDON.toString(), DateUtils.invParseDate(new Date()), DateUtils.invParseDate(new Date()),
	...
	private static VehiculoLocalView crearVehiculoLocalView() {
		...
		v.setVencimientoGarantia(DateUtils.invParseDate(new Date()));
		return v;
	}
