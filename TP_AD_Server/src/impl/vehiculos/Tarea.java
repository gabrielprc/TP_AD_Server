...
public class Tarea extends PersistentObject {
	...
	public Tarea(TareaView tarea) {
		...
		fechaEntrega = DateUtils.parseDate(tarea.getFechaEntrega());
		fechaDevolucion = DateUtils.parseDate(tarea.getFechaDevolucion());
	}
	...
	public TareaView getView() {
		return new TareaView(kilometraje, DateUtils.invParseDate(fechaEntrega), DateUtils.invParseDate(fechaDevolucion));		
	}
