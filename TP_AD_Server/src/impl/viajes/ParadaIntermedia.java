...
public class ParadaIntermedia extends PersistentObject {
	...
	public ParadaIntermedia(ParadaIntermediaView p) {
		this(p.getUbicacion() != null ? new Ubicacion(p.getUbicacion()) : null, DateUtils.parseDate(p.getLlegada()));
	}
	...
	public ParadaIntermediaView getView() { 
		return new ParadaIntermediaView(
			llegadaEsperada != null ? DateUtils.invParseDate(llegadaEsperada) : null,
			llegada != null ? DateUtils.invParseDate(llegada) : null,
			ubicacion.getView(),
			orden
		);
	}
