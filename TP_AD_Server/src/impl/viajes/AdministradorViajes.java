...
public class AdministradorViajes {
	...
	public void crearViajeEnBaseACarga(Carga c, boolean esInternacional) throws Exception {
		...
		ViajeView vv = new ViajeView(DateUtils.invParseDate(calendar.getTime()), DateUtils.invParseDate(c.getFechaMaximaEntrega()), c.getOrigen()
	...
	public String fechaProbable(CargaView c) throws Exception {
		...
		return DateUtils.invParseDate(fechaProbable(carga));
	}
